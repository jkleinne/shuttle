...
const (
	...
	// StatusOptionalMissing means the job was marked optional and its
	// local source was not present at run time. Treated as a non-failure
...
type JobResult struct {
	// Name is the sync job name from the config (e.g. "photos", "docs-to-cloud").
	Name string
	// Remote is the rclone remote name for cloud jobs (e.g. "my_gdrive").
